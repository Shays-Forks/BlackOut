...
public class PistonPush extends BlackOutModule {
    ...
    private void placePiston() {
        ...
        sendPacket(new PlayerMoveC2SPacket.LookAndOnGround(pistonDir.getPositiveHorizontalDegrees(), Managers.ROTATION.lastDir[1], Managers.ON_GROUND.isOnGround(), false));
